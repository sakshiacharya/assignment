...
import earth from '../Images/Industry image.png'
        ...
        <>
            ...
            <div className='main-Market-Container'>
                <section className='indusinfo'>
                    ...
                    <Button className='back' onClick={() => navigate("/industry")}>
                                <img style={{ width: "35px" }} src={back} />
                            </Button>

                     
                        <Button  onClick={() => navigate("/loading")} style={{ width: '40%', background: 'linear-gradient(165.69deg, rgba(104, 108, 248, 0.7) 4.49%, rgba(236, 171, 241, 0.7) 113.71%)', borderRadius: '5px' }}
                                variant="contained" size="large" >Create Store</Button>
                    </div>
                </section>
                
                <section class='indusimg'>
                    <img src={earth} alt="Industry Image" />
                </section>
